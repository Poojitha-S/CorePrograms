...
public class CliniqueManager 
{
	...
	{
		Scanner sc =new Scanner(System.in);
		String doctorFile = "/home/admin1/workspace-eclipse/JavaProgram/src/com/bridgeit/resource/Doctor.json";
		String patientFile = "/home/admin1/workspace-eclipse/JavaProgram/src/com/bridgeit/resource/Patient.json";
		String appointmentFile = "/home/admin1/workspace-eclipse/JavaProgram/src/com/bridgeit/resource/Appointments.json";
		...
		try 
		{
			...
			switch(ch)
			{
				case 1: CliniqueMethods.addDoctor(doctorList);
						break;
					
				case 2: CliniqueMethods.addPatient(patientList);
						break;
				...
				case 5: CliniqueMethods.searchDoctors(doctorList);
						break;
					
				case 6: CliniqueMethods.searchPatients(patientList);
						break;
						
				case 7: CliniqueMethods.fixAppointment(doctorList, patientList);
						break;
						
				case 8: CliniqueMethods.printAppointments(appointmentList);
						break;
