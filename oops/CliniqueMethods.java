...
public class CliniqueMethods 
{
	public static ObjectMapper objMapper = new ObjectMapper();
	public static Search search = new Search();
	public static Scanner sc=new Scanner(System.in);
	public static String doctorFile = "/home/admin1/workspace-eclipse/JavaProgram/src/com/bridgeit/resource/Doctor.json";
	public static String patientFile = "/home/admin1/workspace-eclipse/JavaProgram/src/com/bridgeit/resource/Patient.json";
	public static String appointmentFile = "/home/admin1/workspace-eclipse/JavaProgram/src/com/bridgeit/resource/Appointments.json";
	
	public static void addDoctor(List<Doctor> doctorList) throws ParseException, IOException 
	{
		String avl ;
	...
	public static void addPatient(List<Patient> patientList) throws ParseException, IOException 
	{
	...
	public static void searchDoctors(List<Doctor> doctorList)throws ParseException, IOException 
	{
		int ch;
		do
		{
	...
	public static void searchPatients(List<Patient> patientList)throws ParseException, IOException 
	{
		int ch;
		do
		{
	...
	public static void fixAppointment(List<Doctor> doctorList, List<Patient> patientList )	throws ParseException, IOException 	
	{
		try
		{
	...
	public static void printAppointments(List<Appointment> appointmentList)throws ParseException, IOException 
	{
